...
import com.xabe.choreography.payment.infrastructure.PaymentMother;
import com.xabe.choreography.payment.infrastructure.messaging.mapper.MessagingMapperImpl;
...
class PaymentEventPublisherTest {
  ...
  public void givenAEventCreatedValidWhenInvokeTryPublishThenSendEvent() throws Exception {
    //Given
    final com.xabe.choreography.payment.domain.event.PaymentCreatedEvent event = PaymentMother.createPaymentCreatedEvent();
  ...
  private void assertCreatedPayload(final Object payload, final Event event, final String operationStatus) {
    ...
    final com.xabe.choreography.payment.domain.event.PaymentCreatedEvent paymentCreatedEvent =
        com.xabe.choreography.payment.domain.event.PaymentCreatedEvent.class.cast(event);
