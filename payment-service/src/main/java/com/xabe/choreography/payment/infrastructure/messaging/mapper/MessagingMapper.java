package com.xabe.choreography.payment.infrastructure.messaging.mapper;
...
public interface MessagingMapper {
  ...
  @Mapping(target = "status", expression = "java(com.xabe.choreography.payment.domain.entity.PaymentStatus.ACCEPTED)")
