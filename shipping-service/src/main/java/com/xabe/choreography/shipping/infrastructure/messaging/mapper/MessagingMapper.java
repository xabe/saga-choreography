package com.xabe.choreography.shipping.infrastructure.messaging.mapper;
...
public interface MessagingMapper {
  ...
  @Mapping(target = "status", expression = "java(com.xabe.choreography.shipping.domain.entity.ShippingStatus.ACCEPTED)")
