...
import com.xabe.choreography.order.infrastructure.presentation.mapper.PresentationMapperImpl;
...
class OrderResourceTest {
  ...
  public void shouldGetAllOrders() throws Exception {
    ...
    MatcherAssert.assertThat(orderAggregatePayload.getOrder().getStatus().name(),
        Matchers.is(orderAggregate.getOrder().getStatus().name()));
    MatcherAssert.assertThat(orderAggregatePayload.getOrder().getCreatedAt(), Matchers.is(orderAggregate.getOrder().getCreatedAt()));
    ...
    MatcherAssert.assertThat(orderAggregatePayload.getShipping().getCreatedAt(), Matchers.is(orderAggregate.getShipping().getCreatedAt()));
  }
