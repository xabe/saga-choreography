package com.xabe.choreography.order.infrastructure.integration;
...
import com.xabe.choreography.order.infrastructure.presentation.payload.OrderAggregateStatusPayload;
import com.xabe.choreography.order.infrastructure.presentation.payload.OrderPayload;
import com.xabe.choreography.order.infrastructure.presentation.payload.OrderRequestPayload;
import com.xabe.choreography.order.infrastructure.presentation.payload.OrderStatusPayload;
import com.xabe.choreography.order.infrastructure.presentation.payload.PaymentPayload;
import com.xabe.choreography.order.infrastructure.presentation.payload.PaymentStatusPayload;
import com.xabe.choreography.order.infrastructure.presentation.payload.ShippingPayload;
import com.xabe.choreography.order.infrastructure.presentation.payload.ShippingStatusPayload;
...
public class SagaEventTest {
  ...
  private boolean validateOrder(final OrderAggregatePayload orderAggregatePayload) {
    ...
    assertThat(order.getStatus(), Matchers.is(OrderStatusPayload.CREATED));
  ...
  private boolean validatePayment(final OrderAggregatePayload orderAggregatePayload) {
    ...
    assertThat(payment.getStatus(), Matchers.is(PaymentStatusPayload.ACCEPTED));
  ...
  private boolean validateShipping(final OrderAggregatePayload orderAggregatePayload) {
    ...
    assertThat(shipping.getStatus(), Matchers.is(ShippingStatusPayload.ACCEPTED));
