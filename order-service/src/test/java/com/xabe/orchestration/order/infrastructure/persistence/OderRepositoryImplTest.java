...
class OderRepositoryImplTest {
  ...
  public void shouldGetOrder() throws Exception {
    ...
    assertThat(orderAggregate.getShipping().getId(), is(orderDTO.getShippingId()));
    assertThat(orderAggregate.getShipping().getStatus().name(), is(orderDTO.getShippingStatus().name()));
    assertThat(orderAggregate.getShipping().getCreatedAt(), is(orderDTO.getShippingCreatedAt()));
  }
  ...
  public void shouldCreateOrder() throws Exception {
    ...
    assertThat(orderAggregateResult.getShipping().getId(), is(orderDTO.getShippingId()));
    assertThat(orderAggregateResult.getShipping().getStatus().name(), is(orderDTO.getShippingStatus().name()));
    assertThat(orderAggregateResult.getShipping().getCreatedAt(), is(orderDTO.getShippingCreatedAt()));
    ...
    assertThat(value.getShippingId(), is(orderAggregate.getShipping().getId()));
    assertThat(value.getShippingStatus().name(), is(orderAggregate.getShipping().getStatus().name()));
    assertThat(value.getShippingCreatedAt(), is(orderAggregate.getShipping().getCreatedAt()));
  }
